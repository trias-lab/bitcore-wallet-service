    ...
    async.eachSeries(queryGroups, function(queryGroup, next) {
        ...
        request(requestOptions, function (err, res, body) {
            ...
            try {
                ...
                log.error('etherscan request getMultiAddressBalance parse json error ' + body);
                next(new Error('getMultiAddressBalance parse json error'));
            }
            if (!obj || !obj.result) {
                log.error('etherscan request getMultiAddressBalance parse json no result ' + body);
                next(new Error('getMultiAddressBalance parse json error'));
            }
