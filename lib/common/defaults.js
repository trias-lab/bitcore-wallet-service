...
Defaults.BLOCKHEIGHT_CACHE_TIME_ETH = 10;
Defaults.BLOCKHEIGHT_CACHE_TIME_TRI = 10;
...
Defaults.RateLimit = {
  createWallet: {
    ...
    max: 15*10, // start blocking after 20 request
  ...
  estimateFee: {
   windowMs: 60 * 10 *1000, // 10 min window
    ...
    max: 10*10, // start blocking after 200 request
